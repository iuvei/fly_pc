    ...
    <div class="welcome">
        <div class="banner" style="height: 350px;">
            <Carousel v-model="value" loop v-if="show" arrow="always" :autoplay-speed="3000" :autoplay="true">
                <CarouselItem>
                    <div class="demo-carousel"><img src="../../static/img/banner1.png" class="banner_img" /></div>
                </CarouselItem>
                <CarouselItem>
            ...
            <div class="controlled-block">
                <div class="ant-row-flex ant-row-flex-middle welcome-notice"><span class="notice-label">最新消息/NEWS：</span>
                    <div class="scroll-area">
                        <div class="scroll"><span class="scroll-inner-item">{{msg==''?'欢迎来到全名代理彩票！感谢您对我们的信任，全名代理竭诚带给您最优质的购彩体验，高奖金高回报。选全名代理彩票，赢世界！':msg}}</span></div>
                        <div class="scroll"><span class="scroll-inner-item">{{msg==''?'欢迎来到全名代理彩票！感谢您对我们的信任，全名代理竭诚带给您最优质的购彩体验，高奖金高回报。选全名代理彩票，赢世界！':msg}}</span></div>
                    </div>
                </div>
                <div class="part1 ant-row-flex ant-row-flex-space-between">
                    <div>
                        ...
                        <p class="detail">全名代理集团是用户个人信息的唯一拥有者，不会将资料提供、遗弃或出售给任何第三方</p>
                        <p class="sub-title">购彩安全</p>
                        <p class="detail">全名代理集团根据国家彩票管理部门的官方开奖号码进行开奖，奖金即刻发放到账户中</p>
                    ...
                    <div class="part1-right">
                        <div>
                            ...
                            <p class="detail">为保证用户在游戏过程中信息和资金的安全性，全名代理集团采用了256位SSL国际安全标准的数据加密方式，并设置了多重加密验证，以确保用户的资料及投注数据在网络传输过程中不被篡改和窃取</p>
                        </div>
                        <div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            ...mapMutations(["getUserDetail"]),
            // 外联登录
            _m52Login() {
                const query = this.$route.query;
                let tem_arr = Object.keys(query);
                if (tem_arr.length !== 0) {
                    this.m52Login({
