<template>
	<div class="chargelog">
		<Row>
			...
			<DatePicker :clearable="false" @on-change="search(1)" type="date" :options="options1" placeholder="请选择日期" style="width: 118px" v-model="startTime"></DatePicker>
			<span style="margin: 5px;">-</span>
			<DatePicker :clearable="false" @on-change="search(1)" type="date" :options="options2" placeholder="请选择日期" style="width: 118px" v-model="endTime"></DatePicker>
			</Col>
			<Col span="5">
...
<script>
	...
	export default {
		...
		computed: { ...mapState("account", ['queryChildBillList']),
			...mapState(['userDetail'])
		},
		methods: {
			...mapActions("account", [
