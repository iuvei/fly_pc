<template>
   <com-dialog header="我的银行卡">
  <div class="mybanks"  slot="dialog">
    <Modal
      v-model="modal"
      width="600"
    >
      ...
      <div style="width: 340px;margin: 0 auto;">
        ...
        >
          ...
          >
            ...
            >
              <Option
                v-for="item in companyBankAccountList"
                :key="item.bankNo"
                :value="item.id"
          ...
          >
            <Input
              v-model="formValidate.offshootName"
              placeholder=""
            ></Input>
          </FormItem>
          <FormItem
          ...
          >
            <Input
              v-model="formValidate.bankBranch"
              placeholder=""
            ></Input>
          </FormItem>
          <FormItem
          ...
          >
            <Input
              v-model="formValidate.branchCode"
              placeholder=""
            ></Input>
          </FormItem>
          <FormItem
          ...
          >
            ...
            <Cascader
              :data="address"
              v-model="formValidate.provinceOrCity"
              @on-change="change"
            ></Cascader>
          </FormItem>
          <FormItem
          ...
          <FormItem
            label="确认银行卡号"
            prop="confirmBankAccount"
          >
            <Input
              v-model="formValidate.confirmBankAccount"
              placeholder=""
            ></Input>
          </FormItem>
          <FormItem
          ...
          >
            <Input
              type="password"
              v-model="formValidate.tradePassword"
              placeholder=""
            ></Input>
          </FormItem>
          <FormItem
            label="第一张银行卡号"
            prop="firstBankAccount"
          >
            <Input
              v-model="formValidate.firstBankAccount"
              placeholder=""
            ></Input>
          </FormItem>
        </Form>
      ...
      <div slot="footer">
        ...
        <Button
          type="primary"
          @click="bindBankCard('formValidate')"
        >绑定</Button>
        ...
        <div class="mybanks_table">
          <div class="table-title">
            ...
            <Button
              type="primary"
              @click="modal=true"
              v-if="memberBankAccountList.length < 5"
            >
              新增银行卡</Button>
          </div>
          <Table
...
export default {
        ...
        tradePassword: [
          ...
          },
          {
            validator(rule, value, callback, source, options) {
              var errors = [];
              if (
                !/(?![^a-zA-Z0-9]+$)(?![^a-zA-Z/D]+$)(?![^0-9/D]+$).{6,20}$/.test(
                  value
                )
              ) {
  ...
  methods: {
    ...mapActions("account", ["memberIfBind", "saveMemberOtherBank"]),
    time() {
      var date = new Date();
