			...
			<Modal v-model="modal4" width="700" class="noteDetail">
				...
				<div>
					...
					<Row style="margin-bottom: 24px;">
						...
						<Row>
							<Col span="6">实际输赢：</Col>
							<Col span="18">{{noteDetail.realAmount}}</Col>
						</Row>
						</Col>
					</Row>
					<Row style="margin-bottom: 24px;">
					...
					<Row style="margin-bottom: 24px;">
						<Col span="3">下注号码：</Col>
						<Col span="21">
						<!-- {{noteDetail.lotteryNumbers}} -->
						<textarea readonly v-model="noteDetail.lotteryNumbers"></textarea>
						</Col>
					</Row>
				</div>
				<div slot="footer">
...
<style scoped>
	...
	.mybet_statistice>li:hover,
	.mybet_statistice_c>li:hover {
		background-color: #ebf7ff;
	}
	.mybet_statistice>li>span,
	...
	.mybet_statistice>li>b,
	.mybet_statistice_c>li>b {
		display: inline-block;
		padding: 0 15px;
	}
	.mybet_statistice_c>li>span {
