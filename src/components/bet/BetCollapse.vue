<template>
	<div class="betCollapse">
		<Collapse v-model="defaultOpen">
			...
			<Panel name="3" class="kjtz" style="background: #f7f7f7 !important;">
				最近快捷投注
				<div slot="content">
					<Table border :columns="columns" :data="tableList1"></Table>
					<div style="display:flex ;justify-content: center;padding-top: 9px;" class="btn_box">
						<Button @click="modal2=true">详细信息</Button>
					</div>
				</div>
			</Panel>
		</Collapse>
		<Modal v-model="modal2" width="900">
			...
			<div style="text-align:center">
				<Table border :columns="columns2" :data="tableList2"></Table>
			</div>
			<div slot="footer">
								...
								h('Button', {
									...
									on: {
										click: () => {
											...
											let data = bet_fn.quickBets({
												lotteryData: [params.row],
												kindId: this.kindId,
												orderFrom: "1",
												orderType: "0",
