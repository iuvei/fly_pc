  ...
  <div class="table">
    ...
    <div class="table_footer">
      <Row>
        ...
        <Col span="8">
        <div class="bet_btn">
          <Poptip placement="top-end" confirm :title="title" @on-ok="ok" @on-cancel="cancel" ok-text="确认" cancel-text="我再看看">
  ...
  export default {
    ...
    methods: {
      ...
      changePage(current) {
        ...
        this.showTableList = this.lotteryData.slice(
          (this.current - 1) * 5,
          this.current * 5
        );
      }
    ...
    watch: {
      ...
      subGameList(newList) {
        this.title =
          this.lotteryType[this.classId] +
          "单注最高中奖金额" +
          newList[0].oneNoteLimit +
          "元,单期最高中奖金额" +
          newList[0].singleLimit +
          "元,下注之前请确定期号,请最后确认投注!";
      }
    }
  };
...
<style>
  ...
  .table_footer .clear_btn,
  .table_footer .footer_center div,
  .table_footer .bet_btn {
    display: flex;
    align-items: center;
  }
