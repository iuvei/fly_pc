...
export default {
  ...
  goSportLink(state, res) {
    state.sport_url = res.data
  },
  getBalance(state, res) {
    state.balance = res.data
  },
  getBalance_vg(state, res) {
    state.balance_vg = res.data
  },
  getBalance_lj(state, res) {
    state.balance_lj = res.data
  },
  getBalance_sb(state, res) {
    state.balance_sb = res.data
  },
  getBalance_fl(state, res) {
    state.balance_fl = res.data
  },

  getUrl_sb(state, res) {
    state.urls.url_sb = res.data
  },
  getUrl_lj(state, res) {
    state.urls.url_lj = res.data
  },
  getUrl_vg(state, res) {
    state.urls.url_vg = res.data
  },
  queryActivity(state, data) {
    state.activities = data
  },
  // 是否开始抢红包
	_startRed(state, data) {
		state.isStartRed = data
  },
  // 小于这个值出现抢红包倒计时提示
  _informTime(state, data) {
    state.informTime = data
  },
  // 距红包雨开始剩余时间
	redTime(state, data) {
		state.redPacketTime = data
  },
  // 保存红包雨endTime
  endTime(state, data) {
    state.redEndTime = data
  },
  // 是否开始倒计时
  countDown(state, data) {
    state.isCountDown = data
  },
  initKindId(state, data) {
    state.kindId = data
  }
}
